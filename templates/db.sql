...
CREATE INDEX idx_image_activite_actev ON IMAGE_ACTIVITE(ID_ACT_EV);
...
CREATE TABLE IF NOT EXISTS FAVORIS (
    ...
    ID_ACT_EV INT NOT NULL,
    PRIMARY KEY (ID_CLIENT, ID_ACT_EV),
    FOREIGN KEY (ID_CLIENT) REFERENCES CLIENT(ID_CLIENT)
        ON DELETE CASCADE,
    FOREIGN KEY (ID_ACT_EV) REFERENCES ACTIVITE_EVENEMENT(ID_ACT_EV)
        ON DELETE CASCADE
...
CREATE INDEX idx_favoris_client ON FAVORIS(ID_CLIENT);
CREATE INDEX idx_favoris_actev ON FAVORIS(ID_ACT_EV);